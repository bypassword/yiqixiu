...
<html lang="en" ng-app="app" ng-controller="AppCtrl">
 ...
 if(web_muban_status==1){
	var web_muban ='<div id=home login-loading><header style=background-color:#fff;width:100%;height:60px><div class="we_nav content_center"><div class=link_list><ul class=clearfix><li><a class=background-color-width-change target=_blank href=#/show>秀场</a></li><li><a class=background-color-width-change href=#/privilege>会员特权</a></li><li class=login ng-hide=isAuthenticated()><a class=background-color-width-change ng-click=openLogin()>登录</a></li><li ng-hide=isAuthenticated() class=register><a class=background-color-width-change ng-click=openRegister() id=registerFormBtn>注册</a></li><li ng-show=isAuthenticated()><a class=background-color-width-change href=#/main>进入</a></li></ul></div><div id=logo><em class=eqf-love></em></div></div></header><div id=example_con><div id=example><div slides id=slides><div class=slides_container></div><a href=# class="prev eqf-left"></a> <a href=# class="next eqf-right"></a></div></div></div><div class=active-banner><ul class=clearfix><li ng-repeat="ad in homeAd"><a class=all-change ng-href={{ad.url}} target=_blank><img src="{{ad.path}}"><div class=bg></div></a></li></ul></div></div><div ng-include="\'footer.tpl.html\'"></div>';
		...
		"<div class=\"header-fixed\"><div class=\"header\"><div class=\"header-line\"></div><div class=\"logo\"><a href=\"/\"><img src=\"{{logoSrc}}\"></a></div><div class=\"wrap\"><div class=\"header-nav\"><ul class=\"nav\"><li class=\"current\"><a href=\"/\" hidefocus=\"true\">首页</a></li><li class=\" \"><a href=\"#/show\" hidefocus=\"true\">案例展示</a></li></ul></div></div>			<div class=\"login\"><a ng-hide=\"isAuthenticated()\" ng-click=\"openLogin()\" class=\"l\">登录</a><a ng-hide=\"isAuthenticated()\" ng-click=\"openRegister()\"class=\"r\">注册</a><a ng-show=\"isAuthenticated()\" href=\"#/main\" class=\"l\">进入</a><a ng-show=\"isAuthenticated()\" href=\"index.php?c=user&a=logout\" class=\"r\">退出</a></div></div></div><div class=\"header-shadow\" style=\"display:block;\"></div><div class=\"header\"><div class=\"header-line\"></div><div class=\"logo\"><a href=\"/\"><img src=\"{{logoSrc}}\"></a></div><div class=\"wrap\"><div class=\"header-nav\"><ul class=\"nav\"><li class=\"current\"><a href=\"/\" hidefocus=\"true\">首页</a></li> <li class=\" \"><a href=\"#/show\" hidefocus=\"true\">案例展示</a></li><li ng-repeat='menu in menus' class=\"\"><a href=\"{{menu.url}}\" hidefocus=\"true\">{{menu.name}}</a></li></ul></div></div><div class=\"login\">			<a ng-hide=\"isAuthenticated()\" ng-click=\"openLogin()\" class=\"l\">登录</a><a ng-hide=\"isAuthenticated()\" ng-click=\"openRegister()\"class=\"r\">注册</a>		<a ng-show=\"isAuthenticated()\" href=\"#/main\" class=\"l\">进入</a><a ng-show=\"isAuthenticated()\" href=\"index.php?c=user&a=logout\" class=\"r\">退出</a></div></div><div id=\"float\"><div id=\"float_txt01\"><div align=\"center\">推荐场景<a href=\"javascript:\" class=\"float_close\" onclick='addCookie(\"app\",\"1\",1)'>关闭</a></div></div><div id=\"float_pic\"><img src=\""+tuijian_pic_url+"\"  width=\" 130\" height=\"130\"></div><div id=\"float_button\"><a target=\"_blank\" href=\""+tuijian_url+"\">立即预览</a></div>		</div><div class=\"slide\"><ul class=\"slides-bg\" id='slides_bgcc'>"+
		"{{slides_bgcc}}"+
  ...
  <link rel="stylesheet" href="/assets/eqShow-common-2.0.5.0.css" /> 
  <link rel="stylesheet" href="/assets/eqShow-2.0.5.0.css" /> 
  ...
  <script src="//cdn.bootcss.com/angular.js/1.2.23/angular.js"></script> 
...
<!--jquery.slider.js 70-->
  ...
  <script src="/assets/eqShow-2.0.5.0.js"></script> 
  <style>
.myGrid {
	width: 998px;
	height: 550px;
