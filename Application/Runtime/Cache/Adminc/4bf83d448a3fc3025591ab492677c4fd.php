...
<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">场景列表管理 <small>    Classification management</small></h3>

						<ul class="breadcrumb">
							<li><i class="icon-home"></i><a href="index.html">首页</a> 
								<i class="icon-angle-right"></i></li>
                            <li><a href="#"></i><a href="/adminc.php?c=cate&filetype=<?php echo ($type); ?>"><?php echo (getCateName($type)); ?>分类列表管理</a><i class="icon-angle-right"></i></li>
	...
	<!-- END PAGE HEADER-->
				...
				<li class="<?php echo ($ui["tag_index"]); ?>"><a href="<?php echo U('tag/index');?>">分类列表</a></li>
							</ul>
                            <hr>
                </div>
				<!-- BEGIN PAGE CONTENT-->          
            ...
            <a class="btn green" href="?c=cate&a=add&type=<?php echo ($type); ?>"  style='margin-bottom: 20px;'> 添加分类 </a>
...
<div class="row-fluid"
	...
	<div class="portlet-body" style=" margin-top:15px;">
                ...
                <th align="left" scope="col"><i class="icon-bookmark"></i>分类名</th>
                <th align="left" scope="col"><i class="icon-question-sign"></i>值</th>
            ...
            <?php if(is_array($select)): foreach($select as $key=>$item): ?><tr>
                ...
                <td align="center" ><a  href="?c=cate&a=e&id=<?php echo ($item["id"]); ?>" ><i class="btn black"><i class="icon-edit icon-white"></i></i></a> <a  href="javascript:;" onClick="javascript:if(confirm('你确信要删除[<?php echo ($item["title"]); ?>]吗？')) window.location='?c=cate&a=del&id=<?php echo ($item["id"]); ?>&type=<?php echo ($type); if(($flag) == "useranli"): ?>&flag=useranli<?php endif; ?>'"><i class="btn black"><i class="icon-remove icon-white"></i></i></a>
                   <?php if(($type) != "musType"): ?><a href="?c=tag&a=index&biztype=<?php echo ($item["value"]); ?>&type=<?php echo ($type); ?>">管理小类 </a><?php endif; ?>
              
                </td>
                <td>  <?php echo ($item["title"]); ?></td>
                <td><?php echo ($item["value"]); ?> </td>
                <td> <?php if($item['create_time'] > 0): echo (date("Y-m-d",$item["create_time"])); endif; ?></td>
