...
<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">订单列表管理 <small>    OrderInfo management</small></h3>

						<ul class="breadcrumb">
							<li><i class="icon-home"></i><a href="index.html">首页</a> 
								<i class="icon-angle-right"></i></li>
                            <li><a href="#"></i><a href="/adminc.php?c=order">订单列表管理</a><i class="icon-angle-right"></i></li>
...
<div class="row-fluid"
	...
	<div class="portlet-body" style=" margin-top:15px;">
                ...
                <th align="left" scope="col"><i class="icon-bookmark"></i>订单号</th>
                <th align="left" scope="col"><i class="icon-yen"></i>金额</th>
                  <th align="left" scope="col"> 用户名</th>
                   <th align="left" scope="col"> 商品</th>
                   <th align="left" scope="col"> 订单状态</th>
            ...
            <?php if(is_array($select)): foreach($select as $key=>$item): ?><tr>
                ...
                <td align="center" ><!--<a  href="?c=order&a=e&id=<?php echo ($item["id"]); ?>" ><i class="btn black"><i class="icon-edit icon-white"></i></i></a>--> <a  href="javascript:;" onClick="javascript:if(confirm('你确信要删除[<?php echo ($item["title"]); ?>]吗？')) window.location='?c=order&a=del&id=<?php echo ($item["id"]); ?>&type=<?php echo ($type); ?>'"><i class="btn black"><i class="icon-remove icon-white"></i></i></a>
                ...
                <td><?php echo ($item["order_amount"]); ?> </td>
                 <td><?php echo ($item["user_name"]); ?> </td>
                  ...
                  <td>  <?php echo (getOrderStatus($item[pay_status],$item["order_status"])); ?></td>
                <td> <?php if($item['add_time'] > 0): echo (date("Y-m-d H:i",$item["add_time"])); endif; ?></td>
