...
<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">文章管理 <small>    article management</small></h3>

						<ul class="breadcrumb">
							<li><i class="icon-home"></i><a href="index.html">首页</a> 
								<i class="icon-angle-right"></i></li>
                            <li><a href="#"></i><a href="/adminc.php?c=article">文章列表管理</a><i class="icon-angle-right"></i></li>
            ...
            <a class="btn green" href="?c=article&a=add"  style='margin-bottom: 20px;'> 添加文章 </a>
...
<div class="row-fluid"
	...
	<div class="portlet-body" style=" margin-top:15px;">
                ...
                <th align="left" scope="col"><i class="icon-bookmark"></i>文章名</th>
            ...
            <?php if(is_array($select)): foreach($select as $key=>$item): ?><tr>
                ...
                <td align="center" ><a  href="?c=article&a=e&id=<?php echo ($item["id"]); ?>" ><i class="btn black"><i class="icon-edit icon-white"></i></i></a> <a  href="javascript:;" onClick="javascript:if(confirm('你确信要删除[<?php echo ($item["title"]); ?>]吗？')) window.location='?c=article&a=del&id=<?php echo ($item["id"]); ?>&type=<?php echo ($type); ?>'"><i class="btn black"><i class="icon-remove icon-white"></i></i></a>
                
                </td>
                <td>  <?php echo ($item["title"]); ?></td>
                <td> <?php switch($item["type"]): case "1": ?>关于我们<?php break;?>  
                                       <?php case "2": ?>联系我们<?php break;?> 
                                    <?php case "3": ?>付费方案<?php break;?>                                
                                     <?php case "4": ?>由来<?php break;?>                                
                                     <?php case "5": ?>文化<?php break;?>                                
                                     <?php case "6": ?>团队<?php break;?>                                
                                     <?php case "7": ?>招聘<?php break;?>                                
                                    
                                  		<?php default: ?>其它<?php endswitch;?></td>
