...
<div class="container-fluid">
       ...
       <form action="" method="post">
            ...
            <table style="vertical-align: top;">
               <tr> 
              <td  height="48" align="right">APP ID：</td>
              <td><input type="text" name="THINK_SDK_QQ[APP_KEY]" value="<?php echo (C("THINK_SDK_QQ.APP_KEY")); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例: 101232445 </span>
            </tr> 
                             
       <tr> 
      <td  height="48" align="right">APP KEY：</td>
      <td><input type="text" name="THINK_SDK_QQ[APP_SECRET]" value="<?php echo (C("THINK_SDK_QQ.APP_SECRET")); ?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:dd682e725e85405f772a84f61780feb2   </span>
    </tr> 
       <tr> 
      <td  height="48" align="right">回调地址：</td>
      <td> <?php echo 'http://' . $_SERVER['HTTP_HOST'].'/password.html'; ?> <span>&nbsp;&nbsp;申请QQ互联时填写此地址  &nbsp;&nbsp; <a href="http://connect.qq.com/manage/" target="_blank">申请接入</a>   </span>
    </tr> 
     
       <tr> 
      <td  height="48" align="right">验证的号码：</td>
      <td><input type="text" name="THINK_SDK_QQ[qqqqqq52]" value="<?php echo (C("THINK_SDK_QQ.qqqqqq52")); ?>" class="ipt" size="45" />   <span>&nbsp;&nbsp; 例：  </span>
    &lt;meta property=&quot;qc:admins&quot; content=&quot;55532176310052636&quot; /&gt;  则填写：55532176310052636</tr> 
            </table>
