				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							...
							系统管理 <small>    System management</small>
					...
					<div class="span12 ">
						...
						<?php echo ($updateinfo); ?>
							...
							<div class="well">
                               ...
                               <?php if(($chanageinfo) == ""): ?><h3>恭喜您，您的系统已经是最新的了</h3><?php else: ?><h3><?php echo ($lastver); ?>更新内容</h3><?php endif; ?> 
                               <span class="muted"><?php echo ($domain_time); ?></span>
                                <hr />
