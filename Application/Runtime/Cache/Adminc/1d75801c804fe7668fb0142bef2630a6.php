...
<div class="container-fluid">
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
									...
									<div class="control-group">
									  ...
									  <input name="user[uname]" type="text"   class="m-wrapt"  value="<?php echo ($user["uname"]); ?>" />
	...
	<div class="control-group">
      ...
      <input name="user[email_varchar]" type="text"   class="m-wrapt" value="<?php echo ($user["email_varchar"]); ?>" />
									...
									<div class="control-group">
										...
										<div class="controls">
  <input name="password_varchar" type="password"  class="m-wrap" value="" />   (为空则不修改)
  ...
  <input type="text" name="user[phone]" class="m-wrap"  value="<?php echo ($user["phone"]); ?>"> 
										</div>
									</div> 
  ...
  <input type="text" name="user[tel]" class="m-wrap"  value="<?php echo ($user["tel"]); ?>"> 
										</div>
									</div>       
  ...
  <input type="text" name="user[qq]" class="m-wrap"  value="<?php echo ($user["qq"]); ?>"> 
										</div>
									</div>    
  ...
  <input type="text" name="user[xd]" class="m-wrap"  value="<?php echo ($user["xd"]); ?>"> 
										</div>
									</div>
  ...
  <input type="text" name="user[allow_nums]" class="m-wrap"  value="<?php echo ($user["allow_nums"]); ?>"> 
										</div>
									</div>
	...
	<div class="input-append date date-picker" data-date="2015-05-04" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                   ...
                                   <div class="control-group"><label class="control-label">用户类型</label>
					   <div class="controls"><select name="user[type]" id="type">
	<option value="1" <?php if(($user[type]) == "1"): ?>selected="selected"<?php endif; ?>>普通用户</option>
    <option value="2" <?php if(($user[type]) == "2"): ?>selected="selected"<?php endif; ?>>企业用户</option>
<!--     <option value="21" <?php if(($user[type]) == "21"): ?>selected="selected"<?php endif; ?>>企业子账号</option>
-->    <option value="3" <?php if(($user[type]) == "3"): ?>selected="selected"<?php endif; ?>>高级用户</option>
    <option value="4" <?php if(($user[type]) == "4"): ?>selected="selected"<?php endif; ?>>服务商用户</option>
<!--    <option value="99" <?php if(($user[type]) == "99"): ?>selected="selected"<?php endif; ?>>超级用户</option>
-->  </select></div>
							</div>
					...
					<label class="control-label">用户权限</label>
													<div class="controls">
                         <select  name="user[level_int]" id="dtagid">
                <option  <?php if(($user[level_int]) == "0"): ?>selected="selected"<?php endif; ?> value="0">普通</option>
                <option  <?php if(($user[level_int]) == "4"): ?>selected="selected"<?php endif; ?> value="4">管理模板页</option>
                  ...
                  <input id="ctl00_ContentPlaceHolder1_rdiIsEnable_help_0" type="radio" name="user[status_int]" value="1" <?php if(($user['status_int']) == "1"): ?>checked="checked"<?php endif; ?>/><label for="ctl00_ContentPlaceHolder1_rdiIsEnable_help_0">
                                                        </span></div>
启用
														</label>
														<label class="radio">
														<div class="radio"><span class="">
                <input id="ctl00_ContentPlaceHolder1_rdiIsEnable_help_1" type="radio"   name="user[status_int]" value="0" <?php if(($user['status_int']) == "0"): ?>checked="checked"<?php endif; ?>/><label for="ctl00_ContentPlaceHolder1_rdiIsEnable_help_1">
                                                        </span></div>
禁用
														</label>  
