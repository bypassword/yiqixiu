  ...
  KindEditor.ready(function(K){
   ...
   KindEditor.ready(function(K){
    var editor = K.editor({
	 ...
	 K('#tuijianchangjing').click(function() {
      editor.loadPlugin('image', function() {
        editor.plugin.imageDialog({
          fileUrl : K('#pic1').val(),
          clickFn : function(url, title) {
...
<div class="container-fluid">
				...
				<li class="<?php echo ($ui["sys_set"]); ?>"><a href="<?php echo U('sys/set');?>">网站信息设置</a></li>                
    	<li class="<?php echo ($ui["sys_homeset"]); ?>"><a href="<?php echo U('sys/homeset');?>">首页配置</a></li>
         	<li class="<?php echo ($ui["sys_dhan"]); ?>"><a href="adminc.php?c=ad&filetype=13">导航设置</a></li>
			 	<li class=""><a href="/adminc.php?c=ad&filetype=2">首页大图广告</a></li>
       ...
       <form action="" method="post" class="form-horizontal">
            ...
            <table style="vertical-align: top;">
            	         <tr> 
      <td  height="48" align="right">产品个数：</td>
      <td><input type="text" name="home_products_num" value="<?php echo (C("home_products_num")); ?>" <span>&nbsp;&nbsp;例:70451个产品正在使用一秀微场景 </span>
    </tr>  
                <tr>
                    <td height="48" align="right">首页案例个数:</td>
                    <td>
                  <input name="HOME_PAGESIZE" type="text" value="<?php echo (C("HOME_PAGESIZE")); ?>" />
                  <span>&nbsp;&nbsp;例：12</span>
                    </td>
                </tr>
               <tr>
                    <td height="48" align="right">联系邮箱:</td>
                    <td>
                  <input name="zixun_mail" type="text" value="<?php echo (C("zixun_mail")); ?>" />
                  <span>&nbsp;&nbsp;例：88888888@qq.com</span>
                    </td>
                </tr>


               <tr>
                    <td height="48" align="right">产品咨询QQ:</td>
                    <td>
                  <input name="zixun_qq" type="text" value="<?php echo (C("zixun_qq")); ?>" />
                  <span>&nbsp;&nbsp;例：8888888</span>
                    </td>
                </tr>  
				<tr>
                    <td height="48" align="right">产品咨询电话:</td>
                    <td>
                  <input name="zixun_tel" type="text" value="<?php echo (C("zixun_tel")); ?>" />
                  <span>&nbsp;&nbsp;例：020-88888888</span>
                    </td>
                </tr>
				
				<tr>
                    <td height="48" align="right">技术支持QQ:</td>
                    <td>
                  <input name="jishu_qq" type="text" value="<?php echo (C("jishu_qq")); ?>" />
                  <span>&nbsp;&nbsp;例：99999999</span></td>
                </tr>  
				<tr>
                    <td height="48" align="right">技术支持电话:</td>
                    <td>
                  <input name="jishu_tel" type="text" value="<?php echo (C("jishu_tel")); ?>" />
                  <span>&nbsp;&nbsp;例：13666666666</span></td>
                </tr>
				<tr>
                    <td height="48" align="right">联系地址:</td>
                    <td>
                  <input name="address" type="text" value="<?php echo (C("address")); ?>" />
                  <span>&nbsp;&nbsp;例：广东省广州市天河区</span></td>
                </tr> 				
                
                 <tr>
                    <td height="48" align="right">推荐场景的图片:</td>
                    <td>
					<span class="ke-button-common" id="tuijianchangjing" >
                        <input type="button" class="btn-info" value="Upload">
                   </span>
                  <input id="pic1" name="tuijian_pic_url" type="text" value="<?php echo (C("tuijian_pic_url")); ?>" />
                  <span>&nbsp;&nbsp;例：http://e.wesambo.com/Uploads/pic/7/201505/5560a195a540f.jpg</span></td>
				  
                </tr>  
                  <tr>
                    <td height="48" align="right">推荐场景的链接:</td>
                    <td>
                  <input name="tuijian_url" type="text" value="<?php echo (C("tuijian_url")); ?>" />
                  <span>&nbsp;&nbsp;例：：http://e.wesambo.com/#/sample</span></td>
                </tr>   
                
                       <tr>
                    <td height="48" align="right">公众号二维码图片:</td>
                    <td>
					<span class="ke-button-common" id="gongzhonghao" >
                        <input type="button" class="btn-info" value="Upload">
                   </span>
                  <input id="pic2" name="your_weixinhao_pic_url" type="text" value="<?php echo (C("your_weixinhao_pic_url")); ?>" />
                  <span>&nbsp;&nbsp;例：http://e.wesambo.com/assets/images/help.png'</span></td>
                </tr>  
                  <tr>
                    <td height="48" align="right">优秀案例二维码图片:</td>
                    <td>
					<span class="ke-button-common" id="youxiuanli" >
                        <input type="button" class="btn-info" value="Upload">
                   </span>
                  <input id="pic3" name="your_anli_pic_url" type="text" value="<?php echo (C("your_anli_pic_url")); ?>" />
                  <span>&nbsp;&nbsp;例：http://e.wesambo.com/assets/images/help.png'</span></td>
                </tr>
